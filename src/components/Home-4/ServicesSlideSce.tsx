...
interface customeClassType{
  customeClass:string
}
const ServicesSlideSce = ({customeClass}:customeClassType) => {
  return (
    <>
      <section className={`bd-service-area fix ${customeClass} pb-150`}>
        <div className="container">
          ...
          >
            ...
            <div className="col-xl-4 col-lg-4">
              <div className="bd-service__pagination-wrap ryl-pagination-end mb-25">
                <div className="bd-service-pagination bd-swiper-pagination ryl-pagination"></div>
              </div>
            </div>
          </div>
          <div className="row wow fadeInUp" data-wow-delay=".5s">
            <div className="col-12">
              <div className="bd-service-active ryl-overflow-none">
                <Swiper
...
export default ServicesSlideSce;
