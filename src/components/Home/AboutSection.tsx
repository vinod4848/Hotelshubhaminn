            ...
            <div className="col-lg-6">
              <div className="section-content p-lg-5">
                <div className="bd-section__title-wrapper">
                  ...
                  <p className="mb-30">
                    Shubham Inn Hotel offers unforgettable options. A memorable
                    stay with delicious breakfast Join us in celebrating the new
                    year with a little special surprise from our end.
                  </p>
